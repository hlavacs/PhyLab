    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(v2f input) : SV_Target
            {
				...
				case 0: {
					return  fixed4(_Color0.rrr, 1.0);
				} break;
				case 1: {
					return  fixed4(_Color1.rrr, 1.0);
				} break;
				case 2: {
					return  fixed4(_Color2.rrr, 1.0);
				} break;
				case 3: {
					return  fixed4(_Color3.rrr, 1.0);
				} break;
				case 4: {
					return  fixed4(c.bbb, 1.0);
				} break;
				case 5: {
					return  fixed4(c.ggg, 1.0);
				} break;
				case 6: {
					return  fixed4(c.rrr, 1.0);
				} break;
				case 7: {
					c.rgb *= input.color.rgb;
				} break;
				case 8: {
					return  fixed4(_Color8.rrr, 1.0);
				} break;
				case 9: {
					return  fixed4(_Color9.rrr, 1.0);
				} break;
				case 10: {
					return  fixed4(_Color10.rrr, 1.0);
				} break;
				case 11: {
					return  fixed4(_Color11.rrr, 1.0);
				} break;
				}
