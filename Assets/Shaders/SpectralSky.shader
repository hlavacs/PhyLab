		...
		//              for(int i=0; i<int(kSamples); i++)
				...
				half4 frag(v2f IN) : SV_Target
				{
					...
					// if y < 0 [eyeRay.y > 0] - sky
						...
						if (y < 0.0)
						{
							sun = IN.sunColor * calcSunAttenuation(_WorldSpaceLightPos0.xyz, -ray);
							col += sun;
						}
					#endif
						...
						case 1: {
							col = (_Color1 + _Color1 * sun.r * 0.1f).rrr;
						} break;
						case 2: {
							col = (_Color2 + _Color2 * sun.r * 0.1f).rrr;
						} break;
						case 3: {
							col = (_Color3 + _Color3 * sun.r * 0.1f).rrr;
						} break;
						case 4: {
							col = col.bbb;
						} break;
						...
						case 8: {
							col = (_Color8 + _Color8 * sun.r * 0.1f).rrr;
						} break;
						case 9: {
							col = (_Color9 + _Color9 * sun.r * 0.1f).rrr;
						} break;
						case 10: {
							col = _Color10.rrr;
						} break;
